...
import { UseTreeItem2MinimalPlugins } from "@mui/x-tree-view/useTreeItem2/useTreeItem2.types";
...
const CustomTreeItem = React.forwardRef(function CustomTreeItem(
  ...
  // @ts-ignore - TypeScript does not recognize the public API type correctly
